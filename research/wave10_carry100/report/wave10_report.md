...
|---|---|---|---|---|---|---|---|
| C1 | PASS (레그$45.00, gross1.00x) | PASS (p05=$127.95, ruin=0.00%) | PASS (2.69%) | PASS (56.19%) | PASS (return=0.21%, trades=2) | **PASS** | - |
| C2 | PASS (레그$36.00, gross0.80x) | PASS (p05=$121.78, ruin=0.00%) | PASS (2.21%) | PASS (43.07%) | PASS (return=0.17%, trades=2) | **PASS** | - |
| C3 | PASS (레그$22.50, gross1.00x) | PASS (p05=$134.13, ruin=0.00%) | PASS (1.16%) | PASS (52.79%) | PASS (return=0.11%, trades=2) | **PASS** | - |
| C4 | PASS (레그$40.50, gross0.90x) | PASS (p05=$126.51, ruin=0.00%) | PASS (2.05%) | PASS (51.20%) | UNTESTED_IN_OOS (무포지션) | **UNTESTED_IN_OOS** | 휴면 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| C1 | 13.41% | 21.36% | 13.06% | 15.94% | $14.35 | 0.27% | $0.24 |
| C2 | 10.61% | 16.76% | 10.45% | 12.61% | $11.34 | 0.22% | $0.20 |
| C3 | 12.19% | 23.55% | 9.13% | 14.96% | $13.46 | 0.14% | $0.13 |
| C4 | 11.89% | 18.94% | 13.78% | 14.87% | $13.38 | 0.00% | $0.00 |
