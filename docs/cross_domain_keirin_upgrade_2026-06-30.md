...
추가 검증: `/Users/tttksj/keirin/rolling_confidence_validation.py`.

2021~2026 각 연도를 홀드아웃으로 두고, 해당 연도 직전 데이터까지만 사용해 모델을 다시 학습했다. threshold도 각 fold의 과거 검증구간에서만 고른 뒤 해당 홀드아웃 연도에 적용했다. 이 검증은 단일 2019~2020 선택 후 2021+ 전체에 적용한 표보다 더 보수적이다.

| target | folds | rolling weighted top1 | coverage | races | min held-out year top1 |
|---:|---:|---:|---:|---:|---:|
| 0.78 | 6 | 0.7677 | 0.460 | 5,423 | 0.7544 |
| 0.80 | 6 | 0.7903 | 0.391 | 4,616 | 0.7706 |
| 0.82 | 6 | 0.8086 | 0.325 | 3,835 | 0.7871 |
| 0.85 | 6 | 0.8408 | 0.248 | 2,920 | 0.7915 |
